...
!(function (t, e) {
  ...
  function N(t) {
    return (
      !(function (t) {
        return (
          "symbol" == typeof t ||
          ("object" == typeof t && null !== t && !(Symbol.toPrimitive in t || "toString" in t || "valueOf" in t))
        );
      })(t) &&
      !isNaN(parseFloat(t)) &&
      isFinite(t)
  ...
  function Ni(t, e) {
    ...
    const s = (function (t, e) {
      ...
      return i && s
        ? { left: Wi(i, e, "left"), right: Wi(i, e, "right"), top: Wi(s, e, "top"), bottom: Wi(s, e, "bottom") }
        : e;
    })(e, t.chartArea);
    return {
  ...
  class on {
    ...
    notify(t, e, i, s) {
      ...
      return (
        "afterDestroy" === e &&
          (this._notify(n, t, "stop"), this._notify(this._init, t, "uninstall"), (this._init = void 0)),
        o
      );
    }
    _notify(t, e, i, s) {
  ...
  function Wn(t, e, i, s) {
    ...
    ("middle" === n &&
      ...
      (i._top || 0) === s ? (n = h) : (i._bottom || 0) === s ? (n = c) : ((o[Nn(c, a, r, l)] = !0), (n = h))),
      (o[Nn(n, a, r, l)] = !0),
      (t.borderSkipped = o));
  }
  function Nn(t, e, i, s) {
    ...
    so && !e.options.segment
      ...
      : (function (t, e, i, s) {
          const { segments: n, options: o } = e,
            a = io(e);
          for (const r of n)
            (Jn(t, o, r.style), t.beginPath(), a(t, e, r, { start: i, end: i + s - 1 }) && t.closePath(), t.stroke());
        })(t, e, i, s);
  }
  class oo extends $s {
    static id = "line";
    ...
    buildTicks() {
      ...
      const n = (function (t, e) {
        ...
        for (
          x &&
          (u && M !== a
            ? (i.push({ value: a }), M < a && D++, V(Math.round((M + D * S) * v) / v, a, xo(a, y, t)) && D++)
            : M < a && D++);
          D < k;
          ++D
        ) {
